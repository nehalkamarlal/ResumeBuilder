...
const openai = new OpenAI({
	apiKey:'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'
  });
const database = [];
...
app.post("/resume/create", upload.single("headshotImage"), async (req, res) => {
	...
	const prompt1 = `I am writing a resume, my details are \n name: ${fullName} \n role: ${currentPosition} (${currentLength} years). \n I write in the technolegies: ${currentTechnologies}. \n i have skills :${Education}Can you write a 50 words description for the top of the resume(first person writing)?`;
	...
	const prompt3 = `I am writing a resume, my details are \n name: ${fullName} \n role: ${currentPosition} (${currentLength} years). \n During my years I worked at ${
		workArray.length
	} companies. ${remainderText()} \n Can you write me 30 words for each company seperated in numbers of my succession in the company (in first person)?`;
